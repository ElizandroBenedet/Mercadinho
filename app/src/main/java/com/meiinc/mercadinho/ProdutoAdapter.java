...
public class ProdutoAdapter extends BaseAdapter {
        ...
        @Override
        public long getItemId(Produto arg0) {
            return itens_exibicao.indexOf(arg0);
        }

        @Override
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ItemHelper itemHelper = new ItemHelper();
            Produto objeto = itens_exibicao.get(arg0);

            if (arg1 == null) {
                arg1 = layoutInflater.inflate(R.layout.lista_produtos, null);
